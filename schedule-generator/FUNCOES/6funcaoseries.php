...
$query = "INSERT INTO horarios_turmas(turma, horariosemana) VALUES ('$turmas', '$periodo')";
...
echo "<script>alert('Propostas Cadastradas Com Sucesso!')</script>";
 header("Location: ../6serie.php");
// echo"<script language='javascript' type='text/javascript'>alert('Propostas Salvas Com Sucesso!');window.location.href='../5propostahorario.php;</script>";
?>
