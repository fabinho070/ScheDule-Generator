...
?>
     ...
     <b>ScheDule Generator</b>
      ...
      <?php if(isset($_SESSION["geradohorario"])){
       echo "<br><br><br><br> <h2 class='animated bounce'>Seu Horário foi gerado com sucesso!<br><br>Todos os dados foram preenchidos corretamente.<br><br> Clique <a href='PDFgerado.php'>AQUI</a> para você velo. <br><br> <b style='color:white;'>Equipe ScheDule Generator</b> </h2>";
       }
     else{
     echo "<h2 class='animated bounce'><br><br><br><br>Você ainda não possui horários para ver seus relatórios, clique <a href='1turnos.php'>AQUI</a> para você criar um horário.</h2>";
     }
?>  
</div>
