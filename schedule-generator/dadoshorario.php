...
?>
    ...
    <b>USUÁRIO</b>
     ...
     <?php if(isset($_SESSION["geradohorario"])){
       echo "<h2 class='animated pulse'><br><br><br><br>Você possui um horário gerado com todos seus devidos dados! <br><br> Clique <a href='PDFgerado.php'>AQUI</a> para você velo.</h2>";
       }
     else{
     echo "<h2 class='animated pulse'><br><br><br><br>Você ainda não possui horários para ver seus dados, clique <a href='1turnos.php'>AQUI</a> para você criar um horário.</h2>";
     }
?>
